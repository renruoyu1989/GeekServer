...
namespace BeetleX.Proxy
{
    ...
    //
    internal static class XDispatchProxyGenerator
    {
        ...
        private static readonly MethodInfo s_dispatchProxyInvokeMethod = typeof(XDispatchProxy).GetMethod("Invoke", BindingFlags.NonPublic | BindingFlags.Instance)!;
        ...
        private sealed class ProxyAssembly
        {
            ...
            public ProxyAssembly(AssemblyLoadContext alc)
            {
                ...
                if (!XDispatchProxy.DynamicAssemblyCollectible)
                    builderAccess = alc.IsCollectible ? AssemblyBuilderAccess.RunAndCollect : AssemblyBuilderAccess.Run;
                ...
                [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] Type interfaceType)
            {
                ...
                if (!interfaceType.IsInterface)
                {
                    ...
                    throw new ArgumentException("InterfaceType_Must_Be_Interface T");
                }
                ...
                if (baseType.IsSealed)
                {
                    ...
                    throw new ArgumentException("BaseType_Cannot_Be_Sealed TProxy");
                }
                ...
                if (baseType.IsAbstract)
                {
                    ...
                    throw new ArgumentException("BaseType_Cannot_Be_Abstract TProxy");
                }
                ...
                if (baseType.GetConstructor(Type.EmptyTypes) == null)
                {
                    ...
                    throw new ArgumentException("BaseType_Must_Have_Default_Ctor TProxy");
                }
